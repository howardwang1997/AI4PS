...
class Task:
    def __init__(self, name, **kwargs):
        ...
        self.info = 'TBA'
        self.path = f'datasets/{name}.json'
        self.loaded = False
    ...
    def load(self):
        ...
        with open('datasets/metadata_validation.json') as f:
